@extends('Layouts::app')
@section('title', __('cruds.specialty_request.title'))
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-between items-center">
            <div class="page-title-box my-3">
                <h4 class="page-title">@lang('cruds.specialty_request.title')</h4>
            </div>
        </div>
    </div>
...
@include('Specialty::SpecialtyRequest.partials.script')
