...
namespace App\Domains\Admin\Faq\Controllers;
...
class FaqController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $faqs = Faq::where('faq_status', 'active')->where('faq_type','customer')->orderBy('created_at', 'desc')->paginate(5);
