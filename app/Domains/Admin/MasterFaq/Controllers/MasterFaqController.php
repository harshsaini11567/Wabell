...
namespace App\Domains\Admin\MasterFaq\Controllers;
...
class MasterFaqController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $faqs = Faq::where('faq_status', 'active')->where('faq_type','master')->orderBy('created_at', 'desc')->paginate(5);
            if ($request->ajax()) {
    ...
    public function edit(Request $request, Faq $master_faq)
    {
    ...
    public function update(FaqUpdateRequest $request, Faq $master_faq)
    {
        abort_if(Gate::denies('faq_edit'), Response::HTTP_FORBIDDEN, '403 Forbidden');
        DB::beginTransaction();
        try {
     ...
     */
    public function destroy(Request $request, Faq $master_faq)
    {
