<div class="modal fade show" id="ViewMaster" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-modal="true" >
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">@lang('global.show') @lang('cruds.master.title_singular')</h4>
                        ...
                        <table class="table table-striped">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- <td> {{ $master->neighborhood_id ?? 'N/A' }} </td> -->
                                </tr>
                                <tr>
                                ...
                                <!-- <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td> {!! $master->gender_preference && isset(config('constant.gender_preference')[$master->gender_preference])
                                        ? config('constant.gender_preference')[$master->gender_preference]
                                        : '<span class="text-orange">N/A</span>'  !!}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(!empty($master->profile_image_url))
                                            <a href="{{ $master->profile_image_url }}" target="_blank" rel="noopener noreferrer">
                                                <img src="{{ $master->profile_image_url }}" alt="Profile Image" width="100px">
                                            </a>
                                        @else
                                            <span class="text-orange">N/A</span>
                                        @endif
                                ...
                                <!-- <tr>
                                    ...
                                    <td>  {{ $master->is_approved === null  ? 'N/A' : (config('constant.approval_status')[(int) $master->is_approved] ?? 'N/A') }} </td>
                                </tr> -->
                                <tr>
                                    <th> @lang('cruds.master.fields.created_at') </th>
                                    <td> {{ $master->created_at->format(config('constant.date_format.date_time')) }} </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
