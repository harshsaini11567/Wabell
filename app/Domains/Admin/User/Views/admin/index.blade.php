@extends('Layouts::app')
@section('title', __('cruds.admin.title'))
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-between items-center">
            <div class="page-title-box">
                <h4 class="page-title">@lang('cruds.admin.title')</h4>
            </div>
            <div class="my-3">
                <a href="javascript:void(0);"  class="btn btn-primary btnAddAdmin">@lang('global.create')</a>
            </div>
        </div>
    </div>
...
@section('custom_js')
    ...
    @include('User::admin.partials.script')
