...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على رموز وحروف لاتينية أحادية البايت فقط.',
    ...
    'date_format' => 'يجب أن يطابق تنسيق :attribute الشكل :format.',
    ...
    'max' => [
        ...
        'string' => 'يجب ألا يتجاوز طول النص في :attribute :max حرفًا.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'تم العثور على :attribute في تسريب بيانات. الرجاء اختيار قيمة أخرى.',
        'regex' => 'يجب أن يحتوي :attribute على 8 أحرف على الأقل، مع حرف كبير، رقم، ورمز.',
    ],
    ...
    'invalid' => 'القيمة المدخلة لـ :attribute غير صالحة.',
